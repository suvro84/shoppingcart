...
0,		// Padding
'#E9E9F8',	// Background ('color','transparent','[image_source]')
...
'#D1D1D1',	// BorderColor ('color')
'#4d4c76',	// OVER BorderColor
4,		// Padding
'#D1D1D1',	// Background ('color','transparent','[image_source]')
'#E9E9F8',	// OVER Background
'#252455',	// Color
'#000000',	// OVER Color
...
'#E9E9F8',	// ItemsSeparatorColor ('color','transparent')
...
'#D1D1D1',		// VISITED BorderColor
'#D1D1D1',		// VISITED Background
'#252455',		// VISITED Color
'none',			// VISITED TextDecoration
'[h_arrow.gif]',	// VISITED SubMenuImageSource
'solid',		// CURRENT BorderStyle
'#E9E9F8',		// CURRENT BorderColor
...
'null',		// X Position (values in CSS valid units- px,em,ex)
'null',		// Y Position (values in CSS valid units- px,em,ex)
