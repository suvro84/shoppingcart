...
var w = parseInt(window.screen.width) - parseInt('102');
var h = parseInt(window.screen.height) + parseInt('720');

//document.body.style.overflow="hidden";
    document.write('<div id="dimmer" class="dimmer" style="width:' + w  + 'px; height:'+ h + 'px"></div>');
}
function displayWindow()
		    {
		        ...
		        w = 340;
		        h = 240;
		        l = screen.width/2 - 120;
		        t = screen.height/3 - 70;
                
                // no title		        
		        // displayFloatingDiv('windowcontent', '', w, h, l, t);

                // with title		        
		        displayFloatingDiv('windowcontent', 'Loading..', w, h, l, t);
		    }
